    ...
    public App()
    {
        ...
        AppHost = Host.CreateDefaultBuilder()
            .ConfigureServices((hostContext, services) =>
            {
                ...
                services.AddSingleton<AnalyticsView>();
                ...
                services.AddSingleton<IAnalyticsViewService, AnalyticsViewService>();
                services.AddSingleton<IAnalyticsDayMapper, AnalyticsDayMapper>();
